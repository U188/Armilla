...
object BrowserExternalSchemeHandler {
    ...
    enum class Origin {
         ...
         * ([io.github.mangi.eta.agent.browser.ported.browser.BrowserUseManager]) and the PAGE chose
    ...
    fun handle(
        ...
        return when (route(scheme, origin)) {
            ...
            Route.BLOCK -> {
                ...
                Toast.makeText(
                    context,
                    context.getString(R.string.om_external_link_blocked, scheme),
                    Toast.LENGTH_SHORT,
                ).show()
                true
            }
    ...
    private fun handleIntentScheme(context: Context, url: String): Boolean {
        ...
        Toast.makeText(
            context,
            context.getString(R.string.om_external_link_no_app),
            Toast.LENGTH_SHORT,
        ).show()
        return true
    }
