...
internal object DoubaoVoiceConfig {
    data class Config(val cloudAsr: Boolean = false, val asrKey: String = "", val resource: String = DoubaoAsrProtocol.resources.first(), val cloneKey: String = "", val inputEnabled: Boolean = false, val conversationEnabled: Boolean = true, val duplexEnabled: Boolean = true)
