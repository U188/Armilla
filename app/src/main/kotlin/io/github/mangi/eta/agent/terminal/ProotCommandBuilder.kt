...
internal object ProotCommandBuilder {
    ...
    fun payload(
        ...
        val offloads = TerminalRuntime.minisOffloadsDirectory()
        val browser = TerminalRuntime.minisBrowserDirectory()
        if (offloads != null) bind(offloads.absolutePath, "/var/minis/offloads")
