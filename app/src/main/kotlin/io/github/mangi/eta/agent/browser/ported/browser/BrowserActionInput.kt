    ...
    companion object {
        fun parse(json: String): BrowserActionInput? {
            return try {
                ...
                BrowserActionInput(
                    action = action,
                    offset = obj.optInt("offset", 0).coerceAtLeast(0),
                    maxChars = obj.optInt("max_chars", 8000).coerceIn(1, 12000),
                    ...
                    fuzzy = obj.optBoolean("fuzzy", true),
                    ...
                    timeoutMs = if (obj.has("timeout_ms")) obj.optInt("timeout_ms") else if (obj.has("timeout")) obj.optInt("timeout") else null,
