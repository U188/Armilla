                            ...
                            JSONObject()
                                ...
                                .put(
                                    ...
                                    JSONObject()
                                        ...
                                        .put("description", "android uses the native Android shell with BusyBox applets when available. linux uses the Alpine or Debian environment selected in Armilla settings. Default android.")
                                )
                                .put(
                                    "command",
                                    JSONObject()
